      ...
      <section class="mt-10">
        ...
        <section>
          <nuxt-link to="/feed/new-buildings">
            <article class="w-full h-[200px] bg-cover rounded-lg saturate-50" style="background-image: url(https://storage.yandexcloud.net/backgrounds-images/images/realty_new_building_index.jpg)">
        ...
        <section class="mt-5 grid grid-cols-2 gap-x-5">
          <nuxt-link to="/feed/flats_buy">
            <article class="h-[200px] bg-cover rounded-lg saturate-50" style="background-image: url(https://storage.yandexcloud.net/backgrounds-images/images/realty_flats_index.jpg)">
              <h2 class="mt-5 ml-5 px-2 py-1.5 inline-block text-2xl font-black bg-white rounded">Квартиры</h2>
            </article>
          </nuxt-link>
          <nuxt-link to="/feed/rooms_buy">
            <article class="h-[200px] bg-cover rounded-lg saturate-50" style="background-image: url(https://storage.yandexcloud.net/backgrounds-images/images/realty_rooms_index.jpg)">
        ...
        <section class="mt-5 grid grid-cols-2 gap-x-5">
          <nuxt-link to="/feed/cottage-house-townhouse_buy">
            <article class="h-[420px] bg-cover rounded-lg saturate-50" style="background-image: url(https://storage.yandexcloud.net/backgrounds-images/images/realty_houses%20and%20cottages_index.jpg)">
              <h2 class="mt-5 ml-5 px-2 py-1.5 inline-block text-2xl font-black bg-white rounded">Дома и дачи</h2>
            </article>
          </nuxt-link>
          <section class="grid gap-y-5">
            <nuxt-link to="/feed/commercial_buy">
              <article class="h-[200px] bg-cover rounded-lg saturate-50" style="background-image: url(https://storage.yandexcloud.net/backgrounds-images/images/realty_commercial_index.jpg)">
                <h2 class="mt-5 ml-5 px-2 py-1.5 inline-block text-2xl font-black bg-white rounded">Коммерческая</h2>
              </article>
            </nuxt-link>
            <nuxt-link to="/feed/garages-parking_buy">
              <article class="h-[200px] bg-cover rounded-lg saturate-50" style="background-image: url(https://storage.yandexcloud.net/backgrounds-images/images/realty_land_plots_index.jpg)">
                <h2 class="mt-5 ml-5 px-2 py-1.5 inline-block text-2xl font-black bg-white rounded">Гаражи</h2>
              </article>
            </nuxt-link>
          </section>
        </section>
        ...
        <section class="mt-5">
          <nuxt-link to="/feed/stead_buy">
            <article class="w-full h-[200px] bg-cover rounded-lg saturate-50" style="background-image: url(https://storage.yandexcloud.net/backgrounds-images/images/realty_garages_index.jpg)">
